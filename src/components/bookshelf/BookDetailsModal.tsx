    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#2C302E]/40 backdrop-blur-sm p-4">
        <div className="w-full max-w-4xl bg-[#FCF9F2] rounded-lg shadow-xl flex flex-col max-h-[90vh] overflow-hidden border border-[#E5E0D8]">
          ...
          <div className="flex flex-col items-center md:flex-row md:items-start gap-4 md:gap-6 p-5 md:p-8 border-b border-[#E5E0D8] bg-white relative shrink-0">
            ...
            <div className="flex flex-col items-center md:items-start justify-center flex-1">
              <h2 className="font-heading text-2xl md:text-3xl text-[#2C302E] leading-tight mb-1 text-center md:text-left">{book.title}</h2>
